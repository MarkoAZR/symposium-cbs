...
export const dayColumns: DayColumn[] = [
    ...
    },
    {
        ...
        sessions: [
            ...
            {
                time: "02:00 - 03:15",
                title: "Caracterización de circuitos genéticos usando microscopia hiperespectral in vivo a través de un solo experimento de poli-transfeccion de alto rendimiento",
                type: "research_lecture",
                icon: "🎓",
            ...
            },
            {
                ...
                moderator: { name: "Edward Zapata", role: "Moderador", avatar: "/symposium-cbs/images/panelist/Edward_zapata.jpg", bio: "Investigador GMCAN y ex-participante iGEM Design League 2023" },
                panelists: [
                    ...
                    { name: "Wladimir Tandapilco", role: "Embajador iGEM", avatar: "/symposium-cbs/images/panelist/wladimir.jpg", bio: "Ingeniero en Biotecnología con experiencia en microbiología molecular y biología sintética. Instructor de Dry Lab de iGEM Ecuador y actual embajador de iGEM." },
                ],
            },
        ],
    },
...
export const dayColumnsEN: DayColumn[] = [
        ...
        sessions: [
            {
                ...
                type: "inaugural",
                icon: "🎤",
                description: "Opening remarks by the master of ceremonies, presentation of the board of honor and vision for the I International Symposium of Synthetic Biology CBS 2026, alongside words from our authorities.",
                speakers: [
                    { name: "Marko Zapata", role: "Master of Ceremonies", avatar: "/symposium-cbs/images/team/Marko_zapata.jpg" },
                ],
                subtitle: "We invite you to be part of the beginning of this transformative event in synthetic biology.",
            },
            {
                time: "10:00 - 11:15",
                title: "CF2H: a Cell-Free Two-hybrid platform for rapid protein binder screening and more",
                ...
                speakers: [
                    { name: "Julien Capin", role: "Speaker", avatar: "/symposium-cbs/images/panelist/Julien_Capin.jpg", institution: "France", bio: "Julien obtained a Master's degree in Biotechnology at ENSTBB and completed a PhD in Synthetic Biology at the University of Bristol. His research focuses on CRISPR-Cas9 delivery, protein vaccines against SARS-CoV-2, and since 2021, bacterial cell-free systems and biosensor development at the Centre de Biologie Structurale." },
                ],
                moderator: { name: "Rodrigo Puertas", role: "Moderator", avatar: "/symposium-cbs/images/team/Rodrigo_Puertas.png", bio: "Academic Coordinator of the I International Symposium of Synthetic Biology CBS 2026" },
            },
            {
                time: "11:15 - 12:00",
                title: "Break",
            ...
            },
            {
                ...
                speakers: [
                    { name: "Ana Zúñiga", role: "Speaker", avatar: "/symposium-cbs/images/panelist/Ana_Zuñiga.jpeg", institution: "France", bio: "Dr. Ana Zúñiga obtained her PhD in Molecular Genetics and Microbiology from the Pontificia Universidad Católica de Chile. She was a FONDECYT postdoc and later a researcher at the Centre de Biologie Structurale. Since 2022, she has been a permanent researcher at INSERM, leading work on bacterial biosensors." },
                ],
                moderator: { name: "Rodrigo Puertas", role: "Moderator", avatar: "/symposium-cbs/images/team/Rodrigo_Puertas.png", bio: "Academic Coordinator of the I International Symposium of Synthetic Biology CBS 2026" },
            },
            {
            ...
            },
            {
                ...
                speakers: [
                    { name: "Daniel Schindler", role: "Speaker", avatar: "/symposium-cbs/images/panelist/Daniel_Schindler.jpeg", institution: "Germany", bio: "Daniel studied Biology at Ruhr University Bochum and obtained his PhD from Philipps University Marburg. He was a postdoc at the University of Edinburgh and MIB. Starting in 2025, he is a professor at Heidelberg University (ZMBH)." },
                ],
                moderator: { name: "Mijael Espinoza", role: "Moderator", avatar: "/symposium-cbs/images/team/Mijael_Espinoza.jpg", bio: "Member of the academic committee of the I International Symposium of Synthetic Biology CBS 2026" },
            },
            {
                time: "04:20 - 04:30",
                title: "Break",
            ...
            {
                time: "04:30 - 05:15",
                title: "Comprehensive Workflow in Synthetic Biology: Key tools to optimize every stage",
                type: "speed_talk",
                icon: "⚡",
                description: "Rapid presentation of integral tools to optimize synthetic biology processes.",
                speakers: [
                    { name: "Consuelo Martell Arellano", role: "Biolab Scientific", avatar: "/symposium-cbs/images/panelist/Consuelo_biolab.jpeg", bio: "Consuelo Martell Arellano, biologist from the Universidad Nacional Agraria la Molina, brings over 10 years of experience in lab technology. Currently, she is the Product Manager at BIOLAB SCIENTIFIC, leading technical and commercial strategies for research solutions." },
                ],
            },
        ],
    },
    {
        ...
        sessions: [
            {
                time: "08:00 - 09:15",
                title: "Production of Recombinant Proteins via Synthetic Biology",
                type: "research_lecture",
                icon: "🎓",
                description: "Application of synthetic biology techniques for the efficient production of recombinant proteins.",
                speakers: [
                    { name: "Alberto Donayre", role: "Speaker", avatar: "/symposium-cbs/images/panelist/Donayre.jpg", institution: "UTEC", bio: "PhD in Genetics and Plant Biotechnology from CINVESTAV-IPN, Mexico (2009). Postdoctoral studies at UNAM (2009-2011). He spent five years as a Postdoc in Synthetic Biology at Colorado State University (CSU), USA. Professor of Biotechnology Engineering (Tec de Monterrey, 2014-2016). Research areas: Synthetic Biology, Biotechnology, and Genetic Regulation (Functional Genomics)." },
                ],
                moderator: { name: "Valery Velasquez", role: "Moderator", avatar: "/symposium-cbs/images/team/Valery_Velasquez.jpg", bio: "Member of the academic and alliances committee of the I International Symposium of Synthetic Biology CBS 2026" },
            },
            {
                time: "09:15 - 10:00",
                title: "Break",
            ...
            {
                time: "10:00 - 11:15",
                title: "Use and abuse of bacterial transcription factors",
                type: "research_lecture",
                icon: "🎓",
                description: "Development and application of biosensors based on synthetic biology principles for analyte detection.",
                speakers: [
                    { name: "Daniel Guerra Giraldez", role: "Speaker", avatar: "/symposium-cbs/images/panelist/Daniel_guerra.jpg", institution: "UPCH", bio: "Dr. Daniel Guerra Giraldez is a Professor at the Faculty of Science and Engineering, Head of the Engineering Department, and Director of the Single Molecule Laboratory at UPCH. His work bridges fundamental biophysics with SynBio, spanning high-resolution Single-Molecule Biophysics to genetic circuit engineering. He develops Whole-Cell, cell-free Tx-Tl, and chimeric protein biosensors for detecting mercury, arsenic, and cadmium. He also networks with Reclone, advocating for Open-Source Molecular Biology." },
                ],
                moderator: { name: "Valery Velasquez", role: "Moderator", avatar: "/symposium-cbs/images/team/Valery_Velasquez.jpg", bio: "Member of the academic and alliances committee of the I International Symposium of Synthetic Biology CBS 2026" },
            },
            {
            ...
            {
                time: "02:00 - 03:15",
                title: "Characterization of genetic circuits using in vivo hiperespectral microscopy through a single high-throughput poly-transfection experiment",
                type: "research_lecture",
                icon: "🎓",
                description: "Characterization of genetic circuits using in vivo hiperespectral microscopy through a single high-throughput poly-transfection experiment",
                speakers: [
                    { name: "Benjamín Díaz Zamora", role: "Speaker", avatar: "/symposium-cbs/images/team/benja_cbs.jpg", institution: "UNMSM", bio: "Benjamín Díaz Zamora is a Synthetic Biology researcher with fellowship experience at Dr. Ming-Ru Wu's lab at the Dana-Farber Cancer Institute and Harvard Medical School. He specializes in biopart assembly, bacterial culturing, mammalian cell culturing, transfection, and genetic circuit characterization. His goal is to establish the first synthetic biology biocenter in Peru." },
                ],
                moderator: { name: "Rodrigo Puertas", role: "Moderator", avatar: "/symposium-cbs/images/team/Rodrigo_Puertas.png", bio: "Member of the academic and alliances committee of the I International Symposium of Synthetic Biology CBS 2026" },
            },
            {
                time: "03:15 - 04:00",
                title: "Break",
            ...
            },
            {
                ...
                type: "conversatorio",
                icon: "💬",
                description: "Open dialogue on how students and communities drive synthetic biology research and adoption.",
                moderator: { name: "Edward Zapata", role: "Moderator", avatar: "/symposium-cbs/images/panelist/Edward_zapata.jpg", bio: "GMCAN Researcher and former iGEM Design League 2023 participant" },
                panelists: [
                    { name: "Lya Torres", role: "iGEM Ambassador", avatar: "/symposium-cbs/images/panelist/Lya_conversatorio.jpeg", bio: "B.S. in Biotechnology graduate, with research experience in protein engineering and biological evaluation. Coordinator of the experimental lab for her iGEM 2025 team. Current Latin American iGEM Ambassador." },
                    { name: "Mariana Fernandez", role: "iGEM Ambassador", avatar: "/symposium-cbs/images/panelist/Mariana_Rodriguez.jpg", bio: "Mariana Rodríguez is an undergraduate Biotechnology Engineering student at Tecnológico de Monterrey, Campus Chihuahua, Mexico. Passionate about biology and scientific innovation, she participated in iGEM 2025 developing biotech solutions for her community." },
                    { name: "Nelzy Mendoza", role: "Peruvian Researcher", avatar: "/symposium-cbs/images/panelist/Nelzy_mendoza.jpg", bio: "B.S. in Bioengineering (2025) with experience in synthetic biology and tissue engineering. Member of AylluGene at the iGEM Design League 2023, winning a Silver Medal. Featured as a Leader of Tomorrow by Global Biotech Revolution, attending the GAP Summit 2025 at Cambridge University." },
                    { name: "Wladimir Tandapilco", role: "iGEM Ambassador", avatar: "/symposium-cbs/images/panelist/wladimir.jpg", bio: "Biotechnology Engineer with experience in molecular microbiology and synthetic biology. Dry Lab Instructor for iGEM Ecuador and current iGEM Ambassador." },
                ],
            },
        ],
    },
        ...
        sessions: [
            {
                ...
                type: "research_lecture",
                icon: "🎓",
                description: "Innovative development of oral vaccines via synthetic engineering of probiotics for veterinary applications.",
                speakers: [
                    { name: "Valentina Ramírez", role: "Speaker", avatar: "/symposium-cbs/images/panelist/valentina.jpg", institution: "Ecuador", bio: "Biologist and researcher in synthetic biology and applied biotechnology. Member of the iGEM Ecuador Team, gold medalist in iGEM Competition 2025. Founder of bioengineering university spaces. Beginning her master's at UNESP with a CAPES scholarship." },
                    { name: "Wladimir Tandapilco", role: "Speaker", avatar: "/symposium-cbs/images/panelist/wladimir.jpg", institution: "Ecuador", bio: "Biotechnology Engineer with over six years of expertise in molecular microbiology, synthetic biology, mathematical modeling, and experimental design. Dry Lab Instructor for iGEM Ecuador." },
                ],
                moderator: { name: "Daniela Rojas", role: "Moderator", avatar: "/symposium-cbs/images/team/daniela_rojas.jpg", bio: "Member of the logistics coordination for the I International Virtual Synbio Symposium" },
            },
            {
                time: "09:15 - 10:00",
                title: "Break",
            ...
            },
            {
                ...
                type: "research_lecture",
                icon: "🎓",
                description: "Application of yeasts as biological chassis for compound production and synthesis in synthetic biology.",
                speakers: [
                    { name: "Benjamín Mendoza Téllez", role: "Speaker", avatar: "/symposium-cbs/images/panelist/benjamin_Mendoza.jpg", institution: "Mexico", bio: "Mexican Biologist from UNAM, currently pursuing a graduate degree in Biochemical Sciences. Specifically focused on synthetic biology applied to genetic editing. Gold medalist in iGEM 2024 and collaborator at SynBio LATAM." },
                ],
                moderator: { name: "Marko Zapata", role: "Moderator", avatar: "/symposium-cbs/images/team/Marko_zapata.jpg", bio: "Committee President and logistics coordinator of the I International Virtual Synbio Symposium" },
            },
            {
                time: "11:15 - 02:00",
                title: "Lunch",
            ...
            {
                time: "02:00 - 03:15",
                title: "Application of Mycoplasma sp. as Chassis in the Production of Biomedical Molecules",
                type: "research_lecture",
                icon: "🎓",
                description: "Innovative use of Mycoplasma as a cellular platform for pharmaceutical and biomedical compound synthesis.",
                speakers: [
                    { name: "Alonso Segura Valverde", role: "Speaker", avatar: "/symposium-cbs/images/panelist/alonso.jpg", institution: "Costa Rica", bio: "Molecular biologist and bioinformatician with academic experience in biomedicine and synthetic biology. He co-founded and directs SynBio LATAM and coordinates the SynBio Bootcamp/Hackathon." },
                ],
                moderator: { name: "Marko Zapata", role: "Moderator", avatar: "/symposium-cbs/images/team/Marko_zapata.jpg", bio: "Committee President and logistics coordinator of the I International Virtual Synbio Symposium" },
            },
            {
            ...
            },
            {
                ...
                type: "conversatorio",
                icon: "💬",
                description: "Regional dialogue discussing challenges, opportunities, and the future of synthetic biology in Latin America.",
                moderator: { name: "Marko Zapata", role: "Moderator", avatar: "/symposium-cbs/images/team/Marko_zapata.jpg", bio: "Committee President and logistics coordinator of the I International Virtual Synbio Symposium" },
                panelists: [
                    { name: "Natalie Edwards", role: "iGEM Community", avatar: "/symposium-cbs/images/panelist/natalie_edwards.jpg", bio: "Undergraduate Research Coordinator at the Engineering School of Pontificia Universidad Católica de Chile. She is an iGEM LATAM Ambassador promoting advancements in the region." },
                    { name: "Alonso Segura", role: "Synbio LATAM", avatar: "/symposium-cbs/images/panelist/alonso.jpg", bio: "Molecular biologist with experience in applying synthetic biology to biomedicine. Current director of SynBio LATAM." },
                    { name: "Marco Pereyra", role: "Allbiotech", avatar: "/symposium-cbs/images/panelist/marco_pereyra.jpeg", bio: "Operations Director at Allbiotech. Biotechnological Engineer with a PhD in Molecular Biology. Postdoc at UNAM Biotechnology Institute. Specialist in microbial biotechnology for sustainable bioplastics." },
                    { name: "Antonella Nole", role: "Synbio Bootcamp", avatar: "/symposium-cbs/images/panelist/Antonella_nolle.jpeg", bio: "Biotechnology Engineer and MSc in Bioinformatics, coordinator of the Latin American SynthBio Bootcamp & Hackathon." },
                ],
            },
            {
                time: "05:20 - 06:00",
                title: "Closing Ceremony and Certificate Drawing",
                type: "closing",
                icon: "🎤",
                description: "Final remarks, participant acknowledgments, and a certificate raffle sponsored by Biolab Scientific. Join us in celebrating this collective achievement!",
                speakers: [
                    { name: "Rodrigo Puertas", role: "Moderator", avatar: "/symposium-cbs/images/team/Rodrigo_Puertas.png" },
                ],
                hasDrawing: true,
            },
        ],
